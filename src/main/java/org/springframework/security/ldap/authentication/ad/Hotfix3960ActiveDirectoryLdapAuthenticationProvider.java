 ...
 * since there's not upstream fix yet. Please remove this class as soon as possible when upstream fix is available.
 * Upstream Issue: https://github.com/spring-projects/spring-security/issues/3960
 * See also in ZOE-Jira: http://jira.dm-drogeriemarkt.com/browse/ZOE-1661
 *
 * FIXME: remove this class as soon as there's a fix for issue #3960 in Spring Security upstream!
 */
public final class Hotfix3960ActiveDirectoryLdapAuthenticationProvider extends
     ...
     */
    public Hotfix3960ActiveDirectoryLdapAuthenticationProvider(String domain, String url,
                                                               String rootDn) {
